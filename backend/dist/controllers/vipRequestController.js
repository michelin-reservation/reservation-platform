...
const vipRequestService = __importStar(require("../services/vipRequestService"));
const requestVip = async (req, res) => {
    const vip = await vipRequestService.requestVip(req.body);
    res.json(vip);
};
exports.requestVip = requestVip;
const getVipRequestsByUser = async (req, res) => {
...
//# sourceMappingURL=vipRequestController.js.map