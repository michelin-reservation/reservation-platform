...
const MapComponent: React.FC<MapComponentProps> = ({
  ...
  useEffect(() => {
    ...
    // }
    // const mapScriptUrl = `https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=${naverMapClientId}`;
    const mapScriptUrl = 'https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=ik37jksj5y';
