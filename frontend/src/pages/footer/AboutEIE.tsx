    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <h1 className="mt-6 text-3xl font-medium font-serif mb-8 text-white">
      ...
      <div className="w-full text-center px-4 py-10 bg-gray-100">
        <p className="text-lg text-gray-800 font-medium leading-10 mt-6 mb-6">
          <span className="text-3xl text-red-700 font-serif font-bold">EIE</span> 는<br /> ‘예약 불가’라 알려진 미슐랭급 프리미엄 레스토랑의 식사 경험을 <br />
