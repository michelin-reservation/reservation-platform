    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div>
            <h1 className="text-4xl text-center font-medium font-serif text-[#FAFAF9] mb-4">
              브랜드  스토리
            </h1>
      ...
      <div className="container mx-auto px-6 py-8 mb-12">
        <div className="text-center mt-12 mb-16">
          <h1 className="text-4xl font-semibold text-gray-800 mb-8">
              <span className="text-red-700 font-serif">EIE</span> 의 비전
            </h1>
        ...
        <div className="bg-white text-center shadow-lg p-14">
          <p className="text-lg leading-relaxed text-gray-700 mb-10">
            <span className="font-serif font-medium">EIE</span> 는 미슐랭 스타 레스토랑을 비롯한 고급 다이닝 경험을 누구보다 특별하게 만들어드립니다.
          </p>
          <p className="text-lg leading-10 text-gray-700 mb-16">
            카드사 VIP 전용 고객을 위한, <br />오직 <span className="font-serif font-medium">EIE</span> 만이 제공하는 프라이빗 외식 컨시어지 서비스를 통해<br />그날의 목적, 그 순간의 감정, 그리고 그 사람과의 의미를 완성하는 여정을 돕습니다.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mb-16">" 탄생 배경은 단순했습니다. "</h2>
          ...
          <p className="text-xl leading-relaxed text-gray-700 mb-14">
            우리는 이 모든 ‘복잡함’을 단 하나의 ‘경험’으로 바꾸기로 했습니다.
          </p>

          <p className="text-xl leading-relaxed text-gray-700 mb-3">
            <span className="text-2xl font-serif">EIE</span> 는 세상에 단 하나뿐인 ‘맞춤형 미식 여정’을 디자인합니다.
          </p>
          <p className="text-xl font-semibold text-gray-600 mb-10">오늘, 가장 특별한 순간을 위해, <span className="font-serif text-3xl text-red-700"> EIE</span> 가 함께합니다.</p>
        </div>
      </div>
